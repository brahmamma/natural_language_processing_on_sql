...
class LangConfig:
    ...
    def load(self, path):
        with open(path) as f:
            ...
            self.asc_keywords = list(map(self.remove_accents, map(str.strip, content[11].replace(':',',').split(","))))
            ...
            self.desc_keywords = list(map(self.remove_accents, map(str.strip, content[12].replace(':',',').split(","))))
            ...
            self.group_by_keywords = list(map(self.remove_accents, map(str.strip, content[13].replace(':',',').split(","))))
            ...
            self.negation_keywords = list(map(self.remove_accents, map(str.strip, content[14].replace(':',',').split(","))))
            ...
            self.equal_keywords = list(map(self.remove_accents, map(str.strip, content[15].replace(':',',').split(","))))
            ...
            self.like_keywords = list(map(self.remove_accents, map(str.strip, content[16].replace(':',',').split(","))))
